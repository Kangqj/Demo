...
@interface ARCBlockViewController ()

@end

@implementation ARCBlockViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.row)
    {
        case 0:
        {
            ARCTwoBlocksViewController *viewController = [[ARCTwoBlocksViewController alloc] init];
        ...
        case 1:
        {
            ARCCaptureVarViewController *viewController = [[ARCCaptureVarViewController alloc] init];
            [self.navigationController pushViewController:viewController animated:YES];
